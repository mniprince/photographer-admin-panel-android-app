...
<h3> <a class="btn btn-warning float-right" href="profile_pg.php">Photo List</a></h3>
</br></br>

<div class="row">
<div class="col-4 offset-md-4 form-div">

<form method="POST" action="photo-content-submit.php" enctype="multipart/form-data">
