...
<div class="container" >
<h3>Category List<a class="btn btn-primary float-right" href="add-category.php">Add Category</a></h3>
</br>
...
while($row=mysqli_fetch_array($result)){ ?>
	<tbody>
		<tr>
			...
			<td><img src="<?php echo $row['cimage']; ?>" width="120px" height="130px"></td>
			<td>
<a  class="btn btn-info" href="categoryupdate.php?id=<?php echo $row['id'];?>">Edit</a> &nbsp;
<a  id ="delete" onclick="return myFunction()"  class="btn btn-danger" href="deletecategory.php?id=<?php echo $row['id'];?>">Delete</a>
</td>
</tr>
</tbody>
<?php }
