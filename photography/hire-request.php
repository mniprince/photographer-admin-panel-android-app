...
<div class="container" >
<h3>Request For Photographers</h3>
</br>
...
<th>Photographer Mail</th>
</tr>
</thead>
<?php
$sql= "SELECT * FROM hiretbl";
...
while($row=mysqli_fetch_array($result)){ ?>
	<tbody>
		<tr>
			...
			<td><?php echo $row['hetype']; ?></td>
			<td><?php echo $row['hmsg']; ?></td>
			<td><?php echo $row['pgname']; ?></td>
			<td><?php echo $row['pgmail']; ?></td>
</tr>
</tbody>
<?php }
?>
