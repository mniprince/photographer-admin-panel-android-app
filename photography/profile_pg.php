...
<div class="container" >
<h3>Profile Content<a class="btn btn-primary float-right" href="add-photo-content.php">Add Photo</a></h3>
</br>
...
$sql= "SELECT * FROM pcontent WHERE pg_id='$pg_id'";
...
while($row=mysqli_fetch_array($result)){ ?>
	<tbody>
		<tr>
			...
			<td>
 &nbsp;
<a  id ="delete" onclick="return myFunction()"  class="btn btn-danger" href="deletephotocontent.php?id=<?php echo $row['id'];?>">Delete</a>
</td>
</tr>
</tbody>
<?php }
